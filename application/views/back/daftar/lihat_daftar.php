            ...
            <div class="card">
                <div class="card-body">
                    <div>
                        ...
                        <form action="<?= base_url('daftarsiswa/cetak') ?>" method="post" target="_blank" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" id="id_tahun" name="id_tahun" value="<?= $dafsis->tahun_akademik ?>" readonly placeholder="Tahun Akademik">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="id_jurusan">Jurusan Pilihan</label>
                                        <input class="form-control" type="text" id="id_jurusan" name="id_jurusan" value="<?= $dafsis->nama_jurusan ?>" readonly placeholder="Tahun Akademik">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="pasfoto" style="padding-right: 5px;">Pasfoto Siswa :</label>
                                        <a href="<?= base_url('assets/dokung/' . $dafsis->pasfoto) ?>" target="_blank" class="btn btn-xs btn-secondary">Detail Foto</a>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="dok_akta" style="padding-right: 5px;">Akta Kelahiran Siswa :</label>
                                        <a href="<?= base_url('assets/dokung/' . $dafsis->dok_akta) ?>" target="_blank" class="btn btn-xs btn-secondary">Detail Akta</a>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="dok_ijazah" style="padding-right: 5px;">Ijazah/SKHUN Siswa :</label>
                                        <a href="<?= base_url('assets/dokung/' . $dafsis->dok_ijazah) ?>" target="_blank" class="btn btn-xs btn-secondary">Detail Ijazah/SKHUN</a>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="dok_skl" style="padding-right: 5px;">Surat Keterangan Lulus :</label>
                                        <a href="<?= base_url('assets/dokung/' . $dafsis->dok_skl) ?>" target="_blank" class="btn btn-xs btn-secondary">Detail SKL</a>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="dok_skn" style="padding-right: 5px;">Surat Keterangan Nilai :</label>
                                        <a href="<?= base_url('assets/dokung/' . $dafsis->dok_skn) ?>" target="_blank" class="btn btn-xs btn-secondary">Detail SKN</a>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="dok_rapor" style="padding-right: 5px;">Rapor SMP Siswa :</label>
                                        <a href="<?= base_url('assets/dokung/' . $dafsis->dok_rapor) ?>" target="_blank" class="btn btn-xs btn-secondary">Detail Rapor</a>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="dok_ktp_ortu" style="padding-right: 5px;">KTP Orang Tua Wali :</label>
                                        <a href="<?= base_url('assets/dokung/' . $dafsis->dok_ktp_ortu) ?>" target="_blank" class="btn btn-xs btn-secondary">Detail KTP Ortu</a>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="dok_kk" style="padding-right: 5px;">Kartu Keluarga :</label>
                                        <a href="<?= base_url('assets/dokung/' . $dafsis->dok_kk) ?>" target="_blank" class="btn btn-xs btn-secondary">Detail KK</a>
                                    </div>
                                </div>

                                <?php if ($dafsis->dok_prestasi != NULL && $dafsis->prestasi != NULL) { ?>
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="prestasi" style="padding-right: 5px;">Prestasi Siswa :</label>
                                            <a href="<?= base_url('assets/dokung/' . $dafsis->dok_prestasi) ?>" target="_blank" class="btn btn-xs btn-secondary">Detail Prestasi</a>
                                            <input class="form-control" type="text" id="prestasi" name="prestasi" readonly value="<?= $dafsis->prestasi ?>" placeholder="Prestasi Siswa">
                                        </div>
                                    </div>
                                <?php } ?>
                                <div class="col-12">
                                    <button type="submit" class="btn btn-primary m-b-0">Cetak Pendaftaran</button>
                                </div>
                            </div>
