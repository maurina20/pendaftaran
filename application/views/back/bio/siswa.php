                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" id="pendidikan_ortu" name="pendidikan_ortu" value="<?= $biok->pendidikan_ortu ?>" readonly placeholder="Pendidikan Ortu">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                ...
                                <div class="col-6">
                                    <a href="<?= base_url('biosis/edit_bio/' . $biok->id_siswa) ?>" class="btn btn-primary m-b-0">Edit Data</a>
                                </div>
                            </div>
                        </section>
                    </div>
