                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5">
                                ...
                                <form class="mt-5 mb-5 login-input" action="<?= base_url('auth/proses_login') ?>" method="post">
                                ...
                                <p class="mt-5 login-form__footer">Dont have account? <a href="<?= base_url('auth/registerr') ?>" class="text-primary">Sign Up</a> now |
                                    <a href="<?= base_url('auth/forgot') ?>" class="text-primary">Forgot Password</a>
                                </p>
                            </div>
                        </div>
                    </div>
