                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5">
                                ...
                                <form class="mt-5 mb-5 login-input" action="<?= base_url('auth/proses_register') ?>" method="post">
                                    <?= validation_errors() ?>
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="nama_pengguna" placeholder="Nama Siswa" required>
                                    </div>
                                    <div class="form-group">
