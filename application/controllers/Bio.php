...
class Bio extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->load('back/template', 'back/bio/bio_siswa', $data);
    }
    ...
    function edit_bio($id)
    {
        ...
        if ($data['biok']) {
            $data['bio'] = $this->M_bio->get_bio();
            $this->template->load('back/template', 'back/bio/edit_bio', $data);
        } else {
    ...
    public function detail($id)
    {
        ...
        if ($data['biok']) {
            ...
            $data['bio'] = $this->M_bio->get_bio();
            $this->template->load('back/template', 'back/bio/lihat', $data);
        } else {
            redirect('bio', 'refresh');
        }
    }
